...
bookingType:string='standard'
   ...
   */
  getSelectedFlightData(searchId:string,sequenceNum:number,providerKey:number,pcc:string){
    this.loader = true
   ...
   */
  saveBooking(currentCurrency:string,type:string,pcc:string,pos:string,token:string | null){
    this.loader = true
    this.subscription.add(
